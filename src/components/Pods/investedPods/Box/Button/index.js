...
class Button extends Component {
    ...
    alertDelete() {
        ...
        setTimeout(function() { browserHistory.push('/Pods') }, 2000);
    }
    alertClose() {
        let get = document.getElementById('investedalert');
            ...
            <div className='dropdown'>
                ...
                <ul className='dropdown-menu' aria-labelledby='dropdownMenu1'>
                    <li onClick={this.openModal}>
                        <a><p className='text-danger'>Delete</p></a>
                    </li>
                </ul>
                <Modal
                ...
                >
                    <h2 ref='subtitle'>Do You realy want to Delete[{this.state.name}]?</h2>
                ...
                <div id='investedalert'>
                    <div className='remove' onClick={this.alertClose}>
                        <span className='glyphicon glyphicon-remove' aria-hidden='true'></span>
                    </div>
                    <h4>[Object_name] has been successfully deleted</h4>
                </div>
            </div>
        );
    }
