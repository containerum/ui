    ...
    return (
      <div className='col-md-13'>
        <div className='col-md-4'>
          ...
          <h5>Everyone you refer gets $10 in credit. Once they spent $25 with us, you get $25. There in no limit to the amount of credit you can earn through referrals</h5>
        </div>
