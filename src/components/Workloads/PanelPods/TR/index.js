    ...
    return (
      <tr>
        <td className='width_td'></td>
          <th className='editPodsTable' scope='row' onClick={setDeploymentId}><Link data-id={item.id} to={`/Pods/${item.name}`}>{item.name}<td className='ramGb'>{item.ram} {that.state.ramState}</td></Link></th>
