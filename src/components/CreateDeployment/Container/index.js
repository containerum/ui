...
class Container extends Component {
    ...
    render() {
        return (
        	<div>
		        {
			        new Array(this.props.containersCount).fill().map((item, index) => {
					        ...
					        <div className="blockContainer blockAddContainerPadin">
						        <div className="col-md-12">
							        ...
							        <div
								        ...
								        id={`container${fixedIndex}-parameters`}
							        >
								        <div className="col-md-12">
							        ...
							        <div
								        className="row rowLine"
								        id={`container${fixedIndex}-image-ports`}
							        >
								        <div className="col-md-12">
							        ...
							        <div
								        className="row rowLine"
								        id={`container${fixedIndex}-commands`}
							        >
								        <div className="col-md-12">
							        ...
							        <div
								        className="row rowLine"
								        id={`container${fixedIndex}-enviroments`}
							        >
								        <div className="col-md-12">
							        ...
							        <div
								        className="row rowLine"
								        id={`container${fixedIndex}-volume`}
							        >
								        <div className="col-md-12">
