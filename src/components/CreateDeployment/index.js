	    ...
	    if (!this.props.VolumesByNSReducer.isFetching &&
						    ...
						    this.state.isActiveService ?
							    ...
							    >+ Add Linked Services
								    <span
									    className="myTooltip"
									    data-toggle="tooltip"
									    title="Text of notificatiorem ipsum alist delor set. Text of notification. Lore ipsum delor upset ore ipsum delor upset"
								    >?</span>
							    </div>
					    }
				    </div>
		    ...
		    isFetchingSidebar =
			    <Scrollspy
				    ...
				    <div className="sideMenuHeader" id={`container${1}-info-spy`}>
					    <a
						    className="nav-link sideMenuItem"
						    href={`#container${1}-info`}
					    >Info</a>
				    </div>
				    <div className="sideMenuHeader" id={`container${1}-parameters-spy`}>
					    <a
						    className="nav-link sideMenuItem"
						    href={`#container${1}-parameters`}
					    >Parameters</a>
				    </div>
				    <div className="sideMenuHeader" id={`container${1}-image-ports-spy`}>
					    <a
						    className="nav-link sideMenuItem"
						    href={`#container${1}-image-ports`}
					    >Image Ports</a>
				    </div>
				    <div className="sideMenuHeader" id={`container${1}-commands-spy`}>
					    <a
						    className="nav-link sideMenuItem"
						    href={`#container${1}-commands`}
					    >Commands</a>
				    </div>
				    <div className="sideMenuHeader" id={`container${1}-enviroments-spy`}>
					    <a
						    className="nav-link sideMenuItem"
						    href={`#container${1}-enviroments`}
					    >Enviroments</a>
				    </div>
				    <div className="sideMenuHeader" id={`container${1}-volume-spy`}>
					    <a
						    className="nav-link sideMenuItem"
