...
const ServiceForm = ({
  ...
  const isErrorInternalServiceNameTooltipClass =
    match &&
    !match.url.includes('updateService') &&
    internalSrvNameValue.search(regexp) === -1;
  const isErrorExternalServiceNameTooltipClass =
    match &&
    !match.url.includes('updateService') &&
              ...
              <div className="col-md-6">
                <div className={labelClassName}>
                  <Tooltip
                    ...
                    overlayClassName={
                      isErrorInternalServiceNameTooltipClass
                        ? ''
                        : 'rc-tooltip-hidden'
                    }
                  >
            ...
            <div className={`${globalStyles.paddingL20} row`}>
              ...
              {internalSrvObject.map((item, index) => {
                ...
                const isErrorInternalServicePortNameTooltipClass =
                  internalSrvName.search(regexp) === -1;
                return (
                    ...
                    <div className="col-md-3">
                      <div className={globalStyles.labelLeft}>
                        <Tooltip
                          placement="top"
                          visible
                          overlay={<span>Invalid port name</span>}
                          overlayClassName={
              ...
              <div className="col-md-6">
                <div className={labelClassName}>
                  <Tooltip
                    ...
                    overlay={<span>Invalid service name</span>}
                    overlayClassName={
                      isErrorExternalServiceNameTooltipClass
                        ? ''
                        : 'rc-tooltip-hidden'
                    }
                  >
            ...
            <div className={`${globalStyles.paddingL20} row`}>
              ...
              {externalSrvObject.map((item, index) => {
                ...
                const isErrorExternalServicePortNameTooltipClass =
                  externalSrvName.search(regexp) === -1;
                return (
