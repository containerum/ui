                                ...
                                <table className="table table-hover c-table-card">
                                    ...
                                    <tr>
                                        <td className="i-table-td">
                                            ...
                                            <div className="i-table-inline col-2">Terminated</div>
                                            <div className="i-table-inline col-2">8439 MB</div>
                                            <div className="i-table-inline col-2">0.234</div>
                                            <div className="i-table-inline col-1">11 h</div>
