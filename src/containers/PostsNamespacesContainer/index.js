...
class PostsNamespacesContainer extends Component {
    handleClickTR(href) {
                                                    ...
                                                    return (
                                                        <div className="i-row-table tr-hover" key={id} id={id}>
                                                            <div className="i-td-table" onClick={href => this.handleClickTR(item.name)}>
                                                                <div className="i-label-namespace">
                                                                    <svg className="c-table-card-img-namespaces mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 37.78 33.25">
                                                                        <g>
                                                                ...
                                                                {name} <br />
                                                                <span className="i-active-name">Active</span>
                                                            </div>
                                                            <div className="i-td-table-namespaces i-td-table-pd-top" onClick={href => this.handleClickTR(item.name)}>{item.cpu} CPU</div>
                                                            <div className="i-td-table-namespaces i-td-table-pd-top" onClick={href => this.handleClickTR(item.name)}>{item.memory} MB RAM</div>
                                                            {/*<div className="i-td-table-namespaces text-right">*/}
                                                            ...
                                                            {/*<button className="dropdown-item" type="button">Resize</button>*/}
...
PostsNamespacesContainer.propTypes = {
    PostsNamespacesDataReducer: PropTypes.array
};

export default PostsNamespacesContainer;
